        ...
        <div className="row">
            <div className="col-lg-6">
                <div className="tp-mission-warp pr-75">
                    ...
                    <h3 className="tp-mission-title">The Sree Jayam School <br/> Mission</h3>
                    </div>
